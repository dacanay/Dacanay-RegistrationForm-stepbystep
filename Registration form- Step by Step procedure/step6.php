	...
	<table>
		...
		<form method="POST" action="final step.php">
			...
			<?php if ($studentType=='Full-scholar') { ?>
				<td colspan="3">
				<input type="radio" name="student_type" value="Full-scholar" checked>Full-scholar
				<br>
			...
			<?php }else if ($studentType=='Partial-scholar') { ?>
				<td colspan="3">
				<input type="radio" name="student_type" value="Full-scholar">Full-scholar
				<br>
				<input type="radio" name="student_type" value="Partial-scholar" checked>Partial-scholar
				<br>
				<input type="radio" name="student_type" value="Payee">Payee
			<?php }else{ ?>
				<td colspan="3">
				...
				<input type="radio" name="student_type" value="Partial-scholar">Partial-scholar
				<br>
				<input type="radio" name="student_type" value="Payee" checked>Payee
			<?php } ?>
			<tr>
			<tr>
